...
<link rel="stylesheet" href="css/imgVideo.css" type="text/css"></link>
		...
		<div class="mainContent">
			...
			<div class="gps">
				<ul style="list-style:none;">
					...
					<li><a href="imgVideo.jsp" style="color:#2101A0;">图片视频</a></li>
			...
			<div style="width:100%;height:1000px;">
				...
				<div class="main1" style="float:left;width:330px;height:1000px;">
					...
					<div style="width:330px;height:400px;background:#E6E6E6;">
						<div id="p2_sub">
							<img src="images/p3_sub_title.png">
						</div>
						<div id="newsInfo">
							<ul>
								<li><a href="#" style="color:#2101A0;">宣传视频  PROMOTIONAL VIDEO</a></li>
								<li><a href="#">精彩图集  WONDERFUL ATLAS</a></li>
							</ul>
						</div>
					</div>
					<!-- 球员排名 -->
				...
				<div class="main2" style="float:left;width:650px;height:1000px;">
					...
					<div style="width:100%;height:100px;padding-top:10px;padding-left:10px;">
						<p>您现在的位置：<a href="index.jsp">网站首页</a>-><a href="imgVideo.jsp">图片视频</a>-><a href="#">宣传视频</a>	</p>
					...
					<div style="width:92%;height:800px;margin-left:20px;">
						...
						<div style="width:100%;height:400px;">
							<p>赛事宣传片&nbsp;2015-03-07</p>
							<br/>
							<video width="600" height="280" controls="controls">
						...
						<div style="width:100%;height:300px;padding-top:20px;">
							<div style="width:100%;height:auto;"><img src="images/p3_1_title1.jpg"></div>
							<div style="width:100%;height:250px;margin-top:10px;">
								<div style="float:left;width:30%;height:200px;margin-left:5px;">
									<video width="200" height="180" controls="controls">
										<source src="video/best future.mp4" type="video/ogg">
										Your browser does not support the video tag.
									</video>
								</div>
				...
				<div class="main2" style="display:none;float:left;width:650px;height:1000px;">
					<!-- 标题 -->
					<div style="width:100%;height:100px;padding-top:10px;padding-left:10px;">
						<p>您现在的位置：<a href="index.jsp">网站首页</a>-><a href="imgVideo.jsp">图片视频</a>-><a href="#">精彩图集</a>	</p>
						<div style="width:200px;height:30px;margin-left:200px;margin-top:40px;">
							<img src="images/p3_2_title.png">
						</div>
					</div>
					<!-- 精彩图集    详细信息 -->
					<div style="width:92%;height:800px;margin-left:20px;">
						<!-- 精彩图集 -->
						<div style="width:100%;height:400px;">
							<a href="#"><img src="images/jingcaituji.jpg" width="600px" height="400px"></a>
						</div>
						<!-- 精彩图集上的文字 -->
						<div style="width:300px;height:30px;position:absolute;z-index:1;top:900px;color:white;">每日焦点：球员训练精彩组图</div>
						<!-- 相册 -->
						<div id="xiangce" style="width:100%;height:300px;padding-top:20px;">
							<div style="width:100%;height:auto;"><img src="images/p3_2_title1.jpg"></div>
							<div style="width:100%;height:250px;margin-top:20px;">
								<img src="images/xiangce.jpg">
							</div>
						</div>
						<!-- 相册上面的more 和 a 标签 -->
						<div id="xiangceup" style="display:none;width:430px;height:237px;position:absolute;z-index:1;top:1005px;background:black;filter:alpha(opacity:70);opacity:0.7;color:white;">
							<p style="margin-left:20px;margin-top:60px;"><a href="#" style="text-decoration:none;color:white;">四川国际网球中心</a></p>
							<a href="#"><img src="images/index_more.png" style="margin-left:20px;margin-top:10px;"></a>
						</div>
						<!-- 显示分页 -->
						<div style="width:100%;height:100px;line-height:100px;text-align:center;background:blue;">
							显示分页
