...
<link rel="stylesheet" href="css/cooperativePartner.css" type="text/css"></link>
		...
		<div class="mainContent">
			...
			<div class="gps">
				<ul style="list-style:none;">
					...
					<li><a href="cooperativePartner.jsp" style="color:#2101A0;">合作伙伴</a></li>
			...
			<div style="width:100%;height:1000px;">
				...
				<div class="main1" style="float:left;width:330px;height:1000px;">
					...
					<div style="width:330px;height:400px;background:#E6E6E6;">
						<div id="p2_sub">
							<img src="images/p6_sub_title.png">
						</div>
				...
				<div class="main2" style="float:left;width:650px;height:1000px;">
					...
					<div style="width:100%;height:100px;padding-top:10px;padding-left:10px;">
						<p>您现在的位置：<a href="index.jsp">网站首页</a>-><a href="cooperativePartner.jsp">合作伙伴</a>-><a href="#">合作伙伴</a>	</p>
						<div style="width:200px;height:30px;margin-left:200px;margin-top:40px;">
							<img src="images/p6_1_title.jpg">
						</div>
					</div>
					<!-- 场馆配套   详细信息 -->
					<div style="width:92%;height:850px;margin-left:20px;">
						<div style="width:100%;height:460px;">
							<img src="images/551b9eb369294.jpg" width="600px" height="460px;">
						</div>
