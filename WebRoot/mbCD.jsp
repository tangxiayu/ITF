...
<link rel="stylesheet" href="css/mbCD.css" type="text/css"></link>
		...
		<div class="mainContent">
			...
			<div class="gps">
				<ul style="list-style:none;">
					...
					<li><a href="mbCD.jsp" style="color:#2101A0;">最美蓉城</a></li>
			...
			<div style="width:100%;height:1000px;">
				...
				<div class="main1" style="float:left;width:330px;height:1000px;">
					...
					<div style="width:330px;height:400px;background:#E6E6E6;">
						<div id="p2_sub">
							<img src="images/p7_sub_title.png">
						</div>
						<div id="newsInfo">
							<ul>
								<li><a href="#" style="color:#2101A0;">城市名片  CITY CARD</a></li>
								<li><a href="#">成都宣传片  CHENGDU PROMO</a></li>
							</ul>
						</div>
					</div>
					<!-- 球员排名 -->
				...
				<div class="main2" style="float:left;width:650px;height:1000px;">
					<!-- 标题 -->
					<div style="width:100%;height:70px;padding-top:10px;padding-left:10px;">
						<p>您现在的位置：<a href="index.jsp">网站首页</a>-><a href="mbCD.jsp">最美蓉城</a>-><a href="#">城市名片</a>	</p>
						<div style="width:200px;height:30px;margin-left:200px;margin-top:10px;">
							<img src="images/p3_1_title.jpg">
						</div>
					</div>
					<!-- 城市片名    详细信息 -->
					<div style="width:100%;height:920px;background:#EFEFEF;">
						<div style="width:100%;height:890px;">
							<!-- 左边 -->
							<div style="float:left;width:50%;height:890px;">
								<div style="width:100%;height:320px;">
									<img src="images/5418f4a122b3a.jpg" width="325px" height="320px;">
								</div>
								<div style="width:80%;height:250px;margin-left:20px;font-size:12px;">
									<img src="images/5418f407cf1f2.jpg"><br/><br/>
									<font style="font-size:16px;">成都是一座<br/>充满活力的国际化都市</font>
									<br/>
									是四川省省会，有着1400万人口，是中国西南地区的科技中心、金融中心、商贸中
									心、国际交往中心和交通枢纽、信息枢纽。成都双流国际机场已开通国际航线73条，
									快捷达到纽约、旧金山、伦敦、法兰克福、悉尼等国际大都市。2013年，成都实现
									国民生产总值9108.9亿元人民币，经济总量名列中国省会城市第二位，每年以超过
									10%的速度快速增长，财富之城，成功之都闻名遐迩。 
								</div>
								<div style="width:100%;height:320px;">
									<img src="images/5418f4d4a7036.jpg" width="325px" height="320px;">
								</div>
							</div>
							<!-- 右边 -->
							<div style="float:left;width:50%;height:890px;">
								<div style="width:80%;height:250px;margin-left:20px;font-size:12px;">
									<img src="images/5418f3d108d8b.jpg"><br/><br/>
									<font style="font-size:16px;">成都是一座<br/>历史悠久的文化名城</font><br/>
									 位于中国西南地区，是中国六大古都之一，有三千年左右的建城史，一百五十年建都
									 史，成都自秦汉以来，一直是中国西南地区的政治、经济、军事重镇，也是工商繁茂
									 的大都会。拥有金沙遗址、都江堰、青城山、武侯祠、杜甫草堂、昭觉寺等众多历史
									 名胜古迹和人文景观，拥有2项世界遗产，又因其境内地势平坦、河网纵横、物产丰
									 富、水系发达，自古就有“天府之国”的美誉。 
								</div>
								<div style="width:100%;height:360px;">
									<img src="images/5418f4bacbc2f.jpg" width="325px" height="360px;">
								</div>
								<div style="width:80%;height:210px;margin-left:20px;font-size:12px;">
									<img src="images/5418f439bf762.jpg"><br/><br/>
									<font style="font-size:16px;">成都是一座<br/>热爱网球的城市</font>
									<br/> 随着成都经济社会各方面的迅猛发展，网球运动在成都得到了迅速的普及。全
									 民网球热度不断攀升，据不完全统计，全市目前共拥有网球场地1500多片，拥
									 有网球俱乐部64家，业余网球爱好者超过40万人，每年参加各类网球活动的人数
									 达近400万人次之多。成都的业余网球赛事数量，选手水平都居全国前列。成都
									 还举办过三届ATP冠军巡回赛,ITF国际男子巡回赛、ITF国际青少年网球巡回赛
									 等国际赛事。随着国际网联青少年大师赛的落户，成都将打造全球青少年网球选
									 手的“成功之都”。  
								</div>
							</div>
						</div>
						<!-- 显示分页 -->
						<div style="width:100%;height:30px;line-height:30px;text-align:center;background:blue;">
							显示分页
						</div>
					</div>
				</div>
				...
				<div class="main2" style="display:none;float:left;width:650px;height:1000px;">
					<!-- 标题 -->
					<div style="width:100%;height:150px;padding-top:10px;padding-left:10px;">
						<p>您现在的位置：<a href="index.jsp">网站首页</a>-><a href="mbCD.jsp">最美蓉城</a>-><a href="#">成都宣传片</a>	</p>
						<div style="width:200px;height:30px;margin-left:200px;margin-top:40px;">
							<img src="images/p7_2_title.png">
						</div>
						<div style="width:100%;height:20px;margin-top:20px;margin-left:10px;font-size:14px;color:#2101A0;">
							成都环球中心宣传片
							<img src="images/p7_2_btn.png" style="margin-left:300px;">
						</div>
					</div>
					<!-- 成都宣传片    详细信息 -->
					<div style="width:92%;height:750px;margin-left:20px;">
						<!-- 大视频 -->
						<div style="width:100%;height:250px;">
							<video width="598" height="250" controls="controls">
						...
						<div style="width:100%;height:20px;margin-top:20px;">
							<img src="images/p7_2_title2.png">
						</div>
						<div style="width:100%;height:100px;margin-top:10px;font-size:12px;">
							 &nbsp;&nbsp;新世纪环球中心位于成都高新区天府大道与绕城高速交汇处,占地面积约1300亩,总建筑面积
							 约176万平方米,是省市两级政府确定的打造世界现代田园城市的重大项目,是会展旅游集团继
							 成功开发世纪城新会展中心之后的又一力作. 
						</div>
						<!-- 精彩推荐 -->
						<div style="width:100%;height:30px;">
							<img src="images/p7_2_title3.png">
						</div>
						<div style="width:100%;height:250px;">
